...
import { MyIndesignComponent } from "./my-indesign/my-indesign.component";
import { DigitalArtComponent } from "./digital-art/digital-art.component";
import { MyPaintingsComponent } from "./my-paintings/my-paintings.component";
...
@NgModule({
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: "indesign", component: MyIndesignComponent },
      { path: "illustration", component: MyIllustrationComponent },
      { path: "paintings", component: MyPaintingsComponent },
